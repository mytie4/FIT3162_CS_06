import pool from '../db';
import { Event, EventWithClubName, CreateEventDTO, UpdateEventDTO } from '../entities/event.entity';
...
export async function updateEvent(eventId: string, dto: UpdateEventDTO): Promise<Event | null> {
