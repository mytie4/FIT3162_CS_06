...
export async function create(req: AuthRequest, res: Response) {
    try {
        ...
        console.error("Create event failed:", error instanceof Error ? error.message : error);
...
export async function getById(req: AuthRequest, res: Response) {
    try {
        ...
        console.error("Get event by ID failed:", error instanceof Error ? error.message : error);
        return res.status(500).json({
            error: "Internal server error",
        });
    }
...
export async function getByClubId(req: AuthRequest, res: Response) {
    try {
        ...
        console.error("Get events by club ID failed:", error instanceof Error ? error.message : error);
        return res.status(500).json({
            error: "Internal server error",
        });
    }
...
export async function update(req: AuthRequest, res: Response) {
    try {
        ...
        console.error("Update event failed:", error instanceof Error ? error.message : error);
        return res.status(500).json({
            error: "Internal server error",
        });
    }
...
export async function deleteEvent(req: AuthRequest, res: Response) {
    try {
        ...
        console.error("Delete event failed:", error instanceof Error ? error.message : error);
        return res.status(500).json({
            error: "Internal server error",
        });
    }
